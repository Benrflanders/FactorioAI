...
if platform.system() == 'Linux':
    ...
    FACTORIO_PATH = os.path.join(os.path.expanduser(".."), "factorio")
    USER_PATH = os.path.join(os.path.expanduser(".."), "factorio")
...
def get_load_order(modmap):
    ...
    #filter returns an iterator in python 3, not a list
